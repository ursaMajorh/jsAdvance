...
const validateNumberInput = (a, b, c) => {
  if(typeof a !== "number") return throw new ValidationError('Argumen pertama harus number');
  if(typeof b !== "number") return throw new ValidationError('Argumen kedua harus number');
  if(typeof c !== "number") return throw new ValidationError('Argumen ketiga harus number');
}
